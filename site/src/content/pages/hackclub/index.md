...
After graduating high school in June 2024, I took a gap year at Hack Club to run awesome programs! It was genuinely one of the most invaluable experiences I've ever had and I want to share all the adventures from that year here.
...
_I'll have to find another place to put adventures from programs since my gap year. Another time perhaps_

## Preamble

For context, the programs I run at Hack Club fall under a model called You Ship, We Ship (YSWS for short). The premise is pretty simple - you ship a project, we ship you something in return! That something we ship ranges from funding for your project to an in-person experience (a hackathon, a spot at our booth at an expo, etc!)

It's a really flexible model that incentivizes shipping _real_ projects.

_Author's note: as I've been writing this I realized this page has been way overscoped, so instead I've broken each program up into their own sections:_
